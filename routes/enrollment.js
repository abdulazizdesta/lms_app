...
const { validateEnrollment, validateEnrollmentUpdate } = require('../middleware/validateEnrollment');
...
router.put('/:id', validateAuth.validateToken, validateEnrollmentUpdate, EnrollmentController.update);
